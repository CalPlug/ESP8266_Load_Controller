...
String decodeMessage(String key, String message)
{
   try
   {
    ...
    Cipher cipher_decode = Cipher.getInstance("AES/ECB/PKCS1PADDING");
...
void setup() {
  ...
  subscribed_topic1 = "topic/1";
  published_topic1 = "topic/1";
  subscribed_topic2 = "topic/2";
  published_topic2 = "topic/2";
  subscribed_topic3 = "topic/3";
  published_topic3 = "topic/3";
 ...
 // client.connect("mqtt://client-app:sd2016@m10.cloudmqtt.com:15710", "processing");
  ...
  client.connect("mqtt://xpskpkpr:qoxaerdSjzu5@m10.cloudmqtt.com:16565", "processing");
...
void mousePressed(){
  ...
  */
  if(mouseX>x4 && mouseX <x4+121 && mouseY>y4 && mouseY <y4+118){
   button1 = !button1;
   LED1 = !LED1; 
   publish2topic(button1,subscribed_topic1,RequestLEDon1, RequestLEDoff1, 1);
  }
  if(mouseX>x6 && mouseX <x6+121 && mouseY>y6 && mouseY <y6+118){
   button2 = !button2;
   LED2 = !LED2; 
   publish2topic(button2,subscribed_topic2,RequestLEDon2, RequestLEDoff2, 2);
  }
}
...
void messageReceived(String topic, byte[] payload){
  ...
  if (topic.equals("topic/1") || topic.equals("topic/2"))
  {
  ...
  if (topic.equals("topic/1") && StatusLEDon1.equals(s)){
    button1 = true;
    LED1 = true;
  }
  else if (topic.equals("topic/1") && StatusLEDoff1.equals(s)){
    button1 = false; 
    LED1 = false;
  }
  if (topic.equals("topic/2") && StatusLEDon2.equals(s)){
    button2 = true; 
    LED2 = true;
  }
  else if (topic.equals("topic/2") && StatusLEDoff2.equals(s)){
    button2 = false; 
    LED2 = false;
  }
  if (topic.equals("topic/3"))
  {
    currentValue = s;  
  }
