...
const char HTTP_SCRIPT[] PROGMEM = "<script>function c(l){document.getElementById('s').value=l.innerText||l.textContent;document.getElementById('p').focus();document.getElementById('po').focus();}</script>";
...
const char HTTP_FORM_MQTT[] PROGMEM = "<form method='post' action='MQTTsave'><input id='s' name='s' length=32 placeholder='MQTT SERVER'><br/><input id='po' name='po' length=64 placeholder='MQTT PORT'><br/><input id='u' name='u' length=32 placeholder='MQTT USER'><br/><input id='p' name='p' length=64 type='password' placeholder='MQTT PASSWORD'><br/>";
const char HTTP_FORM_ENCRYPTION_KEY[] PROGMEM = "<form method='post' action='ENCRYPTION_SAVE'><input id='s' name='s' length=32 type='password' placeholder='Encryption Key'><br/>";
...
class WiFiManager
{
  ...
  private:
	...
	void          handleMQTT();
	void          handleMQTTSave();
	void          handleEncryption_Key();
	void          handleEncryption_Key_save();
    void          handleWifiSave();
    void          handleInfo();
    void          handleReset();
    void          handleNotFound();
