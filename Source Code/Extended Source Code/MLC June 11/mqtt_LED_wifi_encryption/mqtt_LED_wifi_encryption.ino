...
const char* mqtt_u = "xpskpkpr";
const char* mqtt_p = "qoxaerdSjzu5";
const char* mqtt_s = "m10.cloudmqtt.com";
const char* mqtt_po = "16565";
...
//    if (client.connect("ESP8266Client", "jhgnolle", "V-eaRkE8L2zK")) {
//    Serial.println();
//    Serial.print("user: "); Serial.print(mqtt_user);
//    Serial.print("     pass: "); Serial.println(mqtt_pwd);
...
/*  delay(10);
 ...
 Serial.println("Setting up Wifi");
    if (!wifiManager.autoConnect("IOT","22team22")) {
...
//      Serial.println(data);
      switch (count)
      {
        ...
        case 7: strcpy(temp_encryption_key, data); break;
      }
      strcpy(data,"");
    } 
    else
...
//  Serial.println(data);
  String encryption_key_str(temp_encryption_key);
  encryption_key_str.getBytes(encryption_key,sizeof(encryption_key));
  Serial.println("encryption key is ");
  Serial.println(encryption_key_str);
  delay(100);
}
...
//  client.setServer(mqtt_server_2, 12986);
...
/**************************Reset start*************/
   if(button.uniquePress()){
    ...
    if(rst>=5){
      ...
      char data[100] = "SSID#ssidpass#m.cloudmqtt.com#12201#hculdksf#GCGrhTnLhphv#dSjzu5#";
      save_data(data);
      ESP.reset();
//      delay(5000);
//      Serial.print("Reseted");
//      wifiManager.autoConnect("IOTMLC","22team22");
